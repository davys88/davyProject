...
public class PagingTag extends TagSupport{
	...
	private String getPaging() {
		...
		//page가 1페이지이고 page_size가 2이면 currentFirst 는 1
		...
		//그래서 총 페이지 수가 나누어 떨어지지 않으면 나머지 레코드를 출력할 페이지 추가
		if(total%list_size != 0) lastPage = lastPage+1;
		//currentlast가 lastPage보다 크면 마지막 페이지 수정
		...
		if(prevLast>0) {
			ret += " <a href=\"javascript:goPage('1')\"><span><img src'../image/common/btn_paginate_prev.gif' alt='이전'/></span></a>";			
		} else {
